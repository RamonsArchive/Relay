  ...
  return (
    <div className="flex flex-col gap-y-3 w-full overflow-y-auto scrollbar-hide p-5">
        <div className="flex flex-col gap-y-3 max-w-lg mx-auto items-center bg-slate-50 p-5 rounded-md shadow-md">
            <h1 className="font-plex-sans font-regular text-[16px] sm:text-[18px] md:text[20px]">About Me</h1>
            ...
            <div className="flex flex-col gap-y-3 w-full">
                ...
                <div className="grid grid-cols-2 gap-3">
                    ...
                    <Image src="/assets/images/whisper.png" alt="Whisper" width={100} height={100} className="w-full h-56 rounded-md object-cover" />
                    <Image src="/assets/images/family.png" alt="Family" width={100} height={100} className="w-full h-56 rounded-md object-cover" />
                    <video 
                        width={400} 
                        height={300} 
                        controls
                ...
                <p className="font-plex-sans font-light text-[10px] md:text-[12px]">
                    ...
                    <strong>Backend:</strong> Node.js, MySQL, Prisma, Sanity CMS<br/>
                    <strong>Cloud & APIs:</strong> Vercel, Oracle Cloud, Stripe, Google Maps<br/>
                    <strong>ML/AI:</strong> YOLOv8, OpenCV, Python, Statistical Analysis<br/>
                    <strong>Tools:</strong> Git, Auth.js, Redis, Webhook Integration
                </p>
                <p className="font-plex-sans font-light text-[10px] md:text-[12px]">
                    I am looking for an internship for the summer of 2026.
                    I am open to any opportunities, so feel free to contact me at rmcdarghmitchell@ucsd.edu or on my social media.
                </p>
                <div className="flex gap-2">
                    <Link href="/" className="flex items-center justify-center flex-1 bg-slate-600 rounded-md">
