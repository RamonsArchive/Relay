...
const ViewReviews = ({
  ...
  return (
    <>
      ...
      >
        <div className="flex flex-col gap-5 h-full w-full p-5 pb-[env(safe-area-inset-bottom)] pt-[env(safe-area-inset-top)] md:pt-5 md:pb-5 overflow-y-auto scrollbar-hidden" style={{
