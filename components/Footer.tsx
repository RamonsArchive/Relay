    ...
    <footer className="flex flex-col gap-y-6 w-full pb-4 px-5 pt-8 border-t border-slate-200">
      <div className="flex flex-col sm:flex-row w-full gap-8 sm:gap-12">
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-2">
            <Link href="/privacy" className="font-plex-sans text-sm text-slate-600 hover:text-slate-800 transition-colors">
              Privacy Policy
            </Link>
            <Link href="/terms" className="font-plex-sans text-sm text-slate-600 hover:text-slate-800 transition-colors">
              Terms of Service
            </Link>
            <Link href="/about" className="font-plex-sans text-sm text-slate-600 hover:text-slate-800 transition-colors">
              About Me
            </Link>
          </div>
        </div>
